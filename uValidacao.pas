...
constructor Validacao.crieObj;
begin

end;

destructor Validacao.destrua_se;
begin

end;

procedure Validacao.validarCaracteres(Sender: TObject; var Key: Char;
  TipoCampo: String);
Const
...
function Validacao.validarData(Data: TDateTime; Tipo: Integer): Boolean;
...
function Validacao.validarEmail(const EMailIn: String): Boolean;
const
...
function Validacao.validarUF(UF: String): Boolean;
const
...
function Validacao.validar_CPF_CNPJ(valor: string): Boolean;
var i : integer;
    equal: char;
    valid : boolean;
